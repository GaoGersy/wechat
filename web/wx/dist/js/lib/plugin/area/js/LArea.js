 ...
 * 因为使用require引入该文件，所以要使用define，返回一个全局对象
 */
 define(function(){
     var LArea = (function() {
    // window.LArea = (function() {
        ...
        MobileArea.prototype = {
                        ...
                        case 2:
                         switch(target.dataset['areatype']){
                             ...
                             case 'area_city':
                                ...
                                console.log(val)
                                console.log(target.childNodes[val])
            ...
            finish: function(e) {
                ...
                var cityAndcounty = ((cityText)?(cityText):(''))+ ((countyText)?(',' + countyText):(''));//只显示市和区（县）
                document.getElementById("areaName").innerHTML=cityAndcounty;
                _self.close(e);
            },
            close: function(e) {
                e.preventDefault();

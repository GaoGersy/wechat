...
public class WeixinMenuButton extends WxMenuButton implements Serializable {

//    public WeixinMenuButton(String menuId, String subMenuIds, String type, String name, String key, String url, String mediaId, String appId, String pagePath) {
//        this.menuId = menuId;
...
//    }
    ...
    public WeixinMenuButton(WxMenuButton wxMenuButton) {
    ...
    public void setSubMenuIds(String subMenuIds) {
        this.subMenuIds = subMenuIds == null ? null : subMenuIds.trim();
    }
